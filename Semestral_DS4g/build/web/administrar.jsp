        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="margin-top: 15;">
                ...
                <div class="container-fluid">
                    ...
                    <h1 style="color: rgb(0,0,0);">Administrar</h1>
                    <hr style="color: rgba(255,255,255,0);">
                    <div class="row row-cols-1 text-center text-dark">
                        <div class="col-auto col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 text-start mb-4"><input type="text" placeholder="Codigo de tema..." style="margin-bottom: 20px;width: 300px;"><input type="text" placeholder="Nombre de tema..." style="margin-bottom: 20px;width: 300px;"><textarea placeholder="Contenido..." style="margin-bottom: 20px;width: 300px;" rows="10" cols="30"></textarea><input type="url" placeholder="Inserte el link HTML de la imagen..." style="margin-bottom: 20px;width: 300px;"><button class="btn btn-primary text-center border rounded-pill border-dark" type="button" style="color: rgb(0,0,0);background: rgba(255,255,255,0);width: 100px;height: 50px;margin-right: 10em;">Cargar</button></div>
