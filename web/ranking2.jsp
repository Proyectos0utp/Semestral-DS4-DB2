                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row row-cols-1 text-center text-dark">
                            <div class="col-12 text-center order-first"><span class="text-start" style="color: rgb(0,0,0);">Tema</span>
                                <h2 class="text-center" style="color: rgb(0,0,0);">Los Alimentos son necesarios para dar energía y movimientos al cuerpo<br></h2>
                            </div>
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="color: rgb(0,0,0);">Estudiante 2</td>
                                                <td style="color: rgb(0,0,0);">4</td>
                                            </tr>
                                            <tr>
                                                <td style="color: rgb(0,0,0);">#2</td>
                                                <td style="color: rgb(0,0,0);">Estudiante 1</td>
                                                <td style="color: rgb(0,0,0);">3</td>
                                            </tr>
                                            <tr>
                                                <td style="color: rgb(0,0,0);">#3</td>
                                                <td style="color: rgb(0,0,0);">Estudiante 5</td>
                                                <td style="color: rgb(0,0,0);">3</td>
                                            </tr>
                                            <tr>
                                                <td style="color: rgb(0,0,0);">#4</td>
                                                <td style="color: rgb(0,0,0);">Estudiante 4</td>
                                                <td style="color: rgb(0,0,0);">2</td>
                                            </tr>
                                            <tr>
                                                <td style="color: rgb(0,0,0);">#5</td>
                                                <td style="color: rgb(0,0,0);">Estudiante 3</td>
                                                <td style="color: rgb(0,0,0);">0</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
